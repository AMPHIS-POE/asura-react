...
const translations = {
  ko: {
    ...
    poe1_builds: '빌드',
    poe1_fansiteLinks: '팬사이트 링크',
    poe1_buildsComingSoon: '빌드 페이지는 준비 중입니다!',
    poe1_starterBuilds: '스타터 빌드',
    poe1_keepersofflame: '불길의 수호자 리그',
  ...
  en: {
    ...
    poe1_keepersofflame: 'Keepers of Flame League',
