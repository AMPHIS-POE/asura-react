...
const translations = {
  ...
  en: {
    ...
    poe1_home: 'Home', poe1_tools: 'Tools', poe1_mapCalculator: '17T Map Calculator', poe1_voriciCalculator: 'Vorici Calculator', poe1_regexGenerator: 'Regex Generator', poe1_builds: 'Builds', poe1_fansiteLinks: 'Fansite Links', poe1_buildsComingSoon: 'Builds page coming soon!',
