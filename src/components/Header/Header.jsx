...
const translations = {
  ko: {
    ...
    poe1_home: '홈', poe1_tools: '도구', poe1_mapCalculator: '17T 지도 계산기', poe1_voriciCalculator: '색채 계산기', poe1_regexGenerator: '정규식 생성기', poe1_ShippingCalculator: '교역 계산기', poe1_builds: '빌드', poe1_fansiteLinks: '팬사이트 링크', poe1_buildsComingSoon: '빌드 페이지는 준비 중입니다!',
  ...
  en: {
    ...
    poe1_home: 'Home', poe1_tools: 'Tools', poe1_mapCalculator: '17T Map Calculator', poe1_voriciCalculator: 'Vorici Calculator', poe1_regexGenerator: 'Regex Generator', poe1_ShippingCalculator: 'Shipping Calculator', poe1_builds: 'Builds', poe1_fansiteLinks: 'Fansite Links', poe1_buildsComingSoon: 'Builds page coming soon!',
