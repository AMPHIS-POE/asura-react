...
const L10N = {
  ko: {
    ...
    infoBoxTitle: '💡 팁 & 정보',
    infoDisclaimer: '본 계산기는 poe.ninja의 시세를 기반으로 한 참고용 지표이며, 실제 실시간 가격과 다를 수 있습니다.',
    infoQuality: '아이템의 퀄리티를 올리면 분해 시 가루의 양이 크게 증가합니다. 이 계산기는 20% 퀄리티를 기준으로 합니다.',
    colItem: '아이템',
    colPrice: '시장가',
    colDust: '가루',
  ...
  en: {
    ...
    infoDisclaimer: 'This calculator is a reference tool based on data from poe.ninja. Actual real-time prices may differ.',
    infoQuality: 'Increasing an item quality to 20% significantly increases its dust yield. This calculator uses 20% quality as the standard for all calculations.',
    colItem: 'Item',
    colPrice: 'Price',
    colDust: 'Dust',
