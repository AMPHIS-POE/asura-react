...
const Poe2ActGuide = ({ lang }) => {
    ...
    useEffect(() => {
        try {
            const savedRecords = JSON.parse(localStorage.getItem('poe2_speedrun_records')) || [];
    ...
    const saveRecordsToLocalStorage = (newRecords) => {
        try {
            localStorage.setItem('poe2_speedrun_records', JSON.stringify(newRecords));
        } catch (e) {
